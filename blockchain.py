...
class Blockchain(object):
    ...
    def register_node(self, address):
        ...
        :param address: <str> адрес узла, другими словам: 'http:/192.168.0.1:5000'
        :return: None
        """
    ...
    def new_block(self, proof, previous_hash=None):
        ...
        :param previous_hash: (Опционально) хэш предыдущего блока
    ...
    def proof_of_work(self, last_proof):
        ...
        - Поиск числа p', так как hash(pp') содержит 4 заглавных нуля, где 
        p - предыдущим доказательством, а p' - новым
    ...
    def valid_chain(self, chain):
        """
        Проверяем, является ли внесенный в блок хэш корректным
        ...
        while current_index < len(chain):
            ...
            # проверьте правильность хэша блока 
    ...
    def resolve_conflicts(self):
        """
        Это наш алгоритм Консенсуса, он разрешает конфликты, заменяет нашу
        цепь на самую длинную в цепи
        ...
        # захватываем и проверяем все ли цепи из всех узлов сети
    ...
    def hash(block):
        ...
        # мы должны убедиться в том, что словать упорядочен, иначе у нас будут непоследовательные хэши
...
def register_nodes():
    ...
    if nodes is None:
        return "Error: Please supply a valid lost of nodes", 400
